  ...
  return (
    <section className="w-full  bg-c-bg h-fit md:h-[560px] flex flex-col relative text-black">
      ...
      <Image
        ...
        height={84}
      />
      <h2 className="font-bold z-10 text-black pt-8 text-[40px] w-fit text-nowrap mx-auto my-auto">
        Nosso Processo
      </h2>
      <motion.div
      ...
      >
        <motion.div className=" max-w-[350px] relative mx-auto text-center">
          ...
          <motion.span
            ...
            viewport={{ once: true }}
          >
            Nossas verduras são cultivadas em solo fértil por agricultores
            experientes, que acompanham todo o ciclo – do plantio à colheita.
            Colhidas no <span className="font-semibold">ponto ideal</span> de
            maturação, garantindo sabor e frescor.
          </motion.span>
        </motion.div>
        <motion.div className=" max-w-[350px] relative mt-12 mx-auto text-center">
          ...
          <motion.span
            ...
            viewport={{ once: true }}
          >
            Nossas verduras passam por uma seleção rigorosa e são embaladas em
        ...
        <motion.div className="mt-12 md:mt-0 max-w-[350px] mx-auto text-center">
          ...
          <motion.span
            ...
            viewport={{ once: true }}
          >
            Levamos até você verduras frescas de qualidade, com transporte ágil
            e acompanhamento para garantir o melhor produto. Nossa equipe é
            treinada para manter altos padrões de qualidade em cada etapa.
          </motion.span>
        </motion.div>
      </motion.div>
    </section>
