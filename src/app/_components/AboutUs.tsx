        ...
        <div className="md:w-fit w-full bg-white flex flex-col lg:grid  lg:grid-rows-1 lg:grid-cols-2 h-fit p-2  lg:py-20 lg:px-10">
            ...
            >
                <MotionImage 
                    ...
                    className="col-span-3 rounded-2xl row-span-2   object-cover w-full h-full  brightness-90 hover:brightness-110"
                />
                <MotionImage 
                    variants={{
                        hidden: { opacity: 0, scale: 0.6 },
                    ...
                    src={RightTop} 
                    alt={"Imagem dividida de homem plantando uma muda no solo"} 
                    className="col-span-1 rounded-2xl row-span-2  object-cover w-full h-full  brightness-90 hover:brightness-110"
                />
                <MotionImage                    
                    variants={{
                        hidden: { opacity: 0, scale: 0.6 },
            ...
            <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true, amount: 0.2 }}
                className="text-2xl">A <span className="text-baseblue font-bold">Beralde verduras</span> garante uma dedicação constante para que receba os melhores produtos.<br/><br /> Direto de Ibiúna - uma das regiões agrícolas mais respeitadas de São Paulo.</motion.p>
                <motion.h3 
                variants={{
                    hidden: { opacity: 0, x: -100, },
                    visible: { opacity: 1, x: 0 },
                ...
                whileInView="visible"
                viewport={{ once: true, amount: 0.2 }}
                className="text-2xl">Desde 2006, fornecemos verduras frescas para empresas na Grande São Paulo, com mais de 15 anos de tradição no campo.</motion.p>
            </motion.div>
        </div>
    )
}